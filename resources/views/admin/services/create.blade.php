    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('procedure') ? 'is-invalid' : '' }}" name="procedure" id="procedure">{!! old('procedure') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_procedure') ? 'is-invalid' : '' }}" type="text" name="video_procedure" id="video_procedure" value="{{ old('video_procedure', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_description') ? 'is-invalid' : '' }}" type="text" name="video_description" id="video_description" value="{{ old('video_description', '') }}">
