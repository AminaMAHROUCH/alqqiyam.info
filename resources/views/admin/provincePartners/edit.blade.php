...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.provincePartner.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.province-partners.update", [$provincePartner->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nom">{{ trans('cruds.provincePartner.fields.nom') }}</label>
                <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom" id="nom" value="{{ old('nom', $provincePartner->nom) }}" required>
                @if($errors->has('nom'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tel_1') ? 'is-invalid' : '' }}" type="text" name="tel_1" id="tel_1" value="{{ old('tel_1', $provincePartner->tel_1) }}">
                @if($errors->has('tel_1'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('adresse') ? 'is-invalid' : '' }}" name="adresse" id="adresse">{{ old('adresse', $provincePartner->adresse) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $provincePartner->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('responsable') ? 'is-invalid' : '' }}" type="text" name="responsable" id="responsable" value="{{ old('responsable', $provincePartner->responsable) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $provincePartner->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tel_2') ? 'is-invalid' : '' }}" type="text" name="tel_2" id="tel_2" value="{{ old('tel_2', $provincePartner->tel_2) }}" required>
                @if($errors->has('tel_2'))
