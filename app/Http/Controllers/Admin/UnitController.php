...
class UnitController extends Controller
{
    public function index()
    {
        ...
        $units = Unit::with(['direction'])->get();
         $directions = Directorate::all()->pluck('title', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.units.index', compact('units', 'directions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.units.create', compact('directions'));
    }
    ...
    public function edit(Unit $unit)
    {
        ...
        return view('admin.units.edit', compact('directions', 'unit'));
    }
